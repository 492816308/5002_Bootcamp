...
public class ChoHan
{
   public static void main(String[] args)
   {
      ...
      // Compare the names of two players.
       if (player1Name.equals(player2Name)) { //if (player1.getName().equals(player2.getName())
         // Call the setNewNames method
          player1.setNewName(player1Name + " 1");
          player2.setNewName(player2Name + " 2");
      }
