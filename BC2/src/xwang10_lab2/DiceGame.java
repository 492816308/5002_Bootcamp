...
/**
 * The DiceGame program plays a die game between the computer and the user.
...
public class DiceGame {
    ...
    public static void main(String[] args) {
        final int DIE1_FAVORED_SIDE = 6; // Favored side of die Computer
        final int DIE2_FAVORED_SIDE = 1; // Favored side of die User
        final int FREQUENCY = 30; // frequency percentage of each player's favored sides
        ...
        do {
            ...
            LoadedDie dieComputer = new LoadedDie(DIE1_FAVORED_SIDE, FREQUENCY);
            LoadedDie dieUser = new LoadedDie(DIE2_FAVORED_SIDE, FREQUENCY);
     ...
     * @param player2 User
     */
    public static void checkValue(LoadedDie player1, LoadedDie player2) {
     ...
     * @param player2 User
     */
    public static void calPoints(LoadedDie player1, LoadedDie player2) {
